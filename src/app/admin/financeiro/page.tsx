...
export default function AdminFinancial() {
  ...
  return (
    <div className="p-6 relative">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {stats.map((s) => {
          ...
          return (
            <div
              key={s.label}
              className="group bg-white rounded-xl border border-zinc-200 p-5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
            >
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-zinc-100">
            <h2 className="text-sm font-semibold text-zinc-900">Faturamento por Serviço</h2>
          </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-zinc-100">
            <h2 className="text-sm font-semibold text-zinc-900">Comissão por Barbeiro</h2>
          </div>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-100">
          <h2 className="text-sm font-semibold text-zinc-900">Transações Recentes</h2>
        </div>
              ...
              {recentTx.map((tx, i) => (
                <tr key={i} className="border-b border-zinc-50 hover:bg-zinc-50 transition-colors">
                  ...
                  <td className="px-5 py-3.5 text-sm text-zinc-500">
                    <span className="text-xs bg-zinc-100 px-2 py-0.5 rounded-full">{tx.method}</span>
                  </td>
